...
- 已实现：Phase 1 项目骨架；Phase 2 后端 `users` migration、注册/登录、认证、当前用户、资料更新、修改密码、头像上传和静态头像访问；Phase 2 前端登录/注册、认证状态、退出登录、个人中心资料展示/编辑/修改密码和收藏占位。
- 未完成/待接入：前端头像上传交互仍为 Profile 页占位；Phase 3 游戏浏览、Phase 4 互动功能、Phase 5 管理后台与资源、Phase 6 搜索和部署。
